...
Funktionen \funk{local:analyze} er en wrapper funktion til \funk{local:analyze2}, som er en rekursiv funktion der behandler xml strukturen et niveau af gangen. For hvert niveau skal alle tags med samme navn behandles og analyseres samlet, så en liste af fundne elementnavne opbygges i linie \lref{04}, og elementnavnet benyttes efterfølgende til at udvælge de elementer der skal behandles, f.eks. i linie \lref{10}, hvor der foretages et rekursivt kald, med alle elementbørn,der matcher det aktuelle navn, som input. 
 Til dette formål er der skrevet  hjælpefunktioner \funk{local:analyze\_maxlength} og \funk{local:analyze\_card}. Resultatet fra disse funktioner tilføjes xml strukturen som attributter sammen med elementets navn. Herefter  
...
10:        {local:analyze2($elements/*[name()=$el])}
11:    </element>
12: };
\end{BVerbatim}
